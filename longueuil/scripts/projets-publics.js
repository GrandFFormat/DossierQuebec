...
//
// LONGUEUIL : copié de levis/scripts/projets-publics.js, qui ne dépend d'aucun champ propre à
// Lévis. Un dossier est un sommaire décisionnel et ses résolutions ; sans sommaire, la
// résolution seule.
//
// PAS de data/attendues.json ici, contrairement à Québec et Lévis : les décisions de Longueuil
// ne portent pas de `statutDossier`, donc on ne sait pas lesquelles attendent encore une
// décision finale. Écrire un fichier vide laisserait croire qu'il n'y a rien en attente — ce
// serait affirmer ce qu'on ignore. Le jour où le scraper produira ce champ, reprendre la
// section correspondante dans levis/scripts/projets-publics.js.
...
const PAS_UN_DOSSIER = new Set(['Procès-verbal', 'Document de séance']);
