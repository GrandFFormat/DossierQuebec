...
const CONSIGNE = `You translate a glossary of French municipal terms (City of Montréal, Canada) into clear, simple
...
Urban agglomeration council; Conseil d'arrondissement → Borough council; Avis de motion → Notice of
motion; Règlement → By-law). Montréal borough names stay in French. Translate
...
(CM26 0570, CA26 25 0172, a ten-digit file number) exactly. null stays null. Translate the category titles too (same keys).`;
